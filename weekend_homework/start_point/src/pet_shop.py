...
def sell_pet_to_customer(pet_shop,pet_sold,customer):
    for pet in pet_shop['pets']:
            if pet_sold and pet['name'] == pet_sold['name']:
                if customer['cash'] >= pet_sold['price']:
                    customer['pets'].append(pet)
                    pet_shop['admin']['pets_sold'] += 1
                    customer['cash'] -= pet_sold['price']
                    pet_shop['admin']['total_cash'] += pet_sold['price']
